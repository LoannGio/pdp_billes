...
\KwOut{}
   ...
   \nl {\bf direction1} = Ball1.getAngle();\\
   \nl {\bf direction2} = Ball2.getAngle();\\
   \nl {\bf collisionAngle} = getCollisionAngle();\\
   \nl {\bf newV1x} = V1 * Cos(direction1-collisionAngle);\\ 
   \nl {\bf newV1y} = V1 * Sin(direction1-collisionAngle);\\
   \nl {\bf newV2x} = V2 * Cos(direction2-collisionAngle);\\ 
   \nl {\bf newV2y} = V2 * Sin(direction2-collisionAngle);\\
   \nl {\bf finalV1x} = ((mass1-mass2) * newV1x + (2*mass2) * newV2x)/(mass1+mass2);\\ 
   \nl {\bf finalV2x} = ((2*mass1) * newV1x + (mass2 - mass1) * newV2x)/(mass1+mass2);\\
   \nl {\bf Ball1.Vx} = Cos(collisionAngle) * finalV1x - Sin(collisionAngle) * newV1y;\\
   \nl {\bf Ball1.Vy} = Sin(collisionAngle) * finalV1x + Cos(collisionAngle) * newV1y;\\
   \nl {\bf Ball2.Vx} = Cos(collisionAngle) * finalV2x - Sin(collisionAngle) * newV2y;\\
   \nl {\bf Ball2.Vy} = Sin(collisionAngle) * finalV2x + Cos(collisionAngle) * newV2y;
\end{algorithm}
...
\KwOut{}
   ...
   \nl {\bf incoming} = Ball.getAngle();\\
   \nl {\bf normal} = getNormaleAngle();\\
   \nl {\bf outgoing} = 2 * normal -180 - incoming;\\
   \nl {\bf Ball.Vx} = Cos(outgoing) * Ball.getSpeed();\\
   \nl {\bf Ball.Vy} = Sin(outgoing) * Ball.getSpeed();\\
\end{algorithm}
